...
Run:  uv run python paper_utils/boundary/downstream/smoke_test.py
      uv run python paper_utils/boundary/downstream/smoke_test.py --tokenizer-dir <dir>
"""
...
DEFAULT_DIR = os.path.join(REPO, "paper_utils", "boundary", "tokenizers")
